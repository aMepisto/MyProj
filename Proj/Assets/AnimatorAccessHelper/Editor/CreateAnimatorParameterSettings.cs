...
//            var controller = AssetDatabase.LoadAssetAtPath(str, typeof(AnimatorController)) as AnimatorController;
...
//        {
//            var param = animatorController.GetParameter(i);

//            string code = string.Empty;
//                string name = StripSpace(param.name);
//                if (param.type == AnimatorControllerParameterType.Bool)
//                    code = string.Format(boolPropertyTemplate, name, param.GetHashCode());
//                if (param.type == AnimatorControllerParameterType.Float)
//                    code = string.Format(floatPropertyTemplate, name, param.GetHashCode());
//                if (param.type == AnimatorControllerParameterType.Int)
//                    code = string.Format(intPropertyTemplate, name, param.GetHashCode());
//                if (param.type == AnimatorControllerParameterType.Trigger)
//                    code = string.Format(triggerTemplate, name, param.GetHashCode());
...
//        {
//            var layer = animatorController.GetLayer(i);
...
//    static void StateCheck(StateMachine statemachiene, string stateNameSpace, ref Dictionary<string, int> hashState)
//    {
